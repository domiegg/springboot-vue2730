    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="货物名称" prop="goodsName">
                       <el-input v-model="ruleForm.goodsName"
                                 placeholder="货物名称" clearable  :readonly="ro.goodsName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="货物类型" prop="goodsTypes">
                        <el-select v-model="ruleForm.goodsTypes" :disabled="ro.goodsTypes" placeholder="请选择货物类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="货物数量" prop="goodsKucunNumber">
                       <el-input v-model="ruleForm.goodsKucunNumber"
                                 placeholder="货物数量" clearable  :readonly="ro.goodsKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="货物数量" prop="goodsKucunNumber">
                           <el-input v-model="ruleForm.goodsKucunNumber"
                                     placeholder="货物数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="货物价格" prop="goodsMoney">
                       <el-input v-model="ruleForm.goodsMoney"
                                 placeholder="货物价格" clearable  :readonly="ro.goodsMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="货物价格" prop="goodsMoney">
                           <el-input v-model="ruleForm.goodsMoney"
                                     placeholder="货物价格" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="货物详情" prop="goodsContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsContent" label="货物详情" prop="goodsContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   goodsPhoto: [
                              { required: true, message: '货物图片不能为空', trigger: 'blur' },
                          ],
                   goodsKucunNumber: [
                   ...
                   goodsMoney: [
                              { required: true, message: '货物价格不能为空', trigger: 'blur' },
                   ...
                   goodsContent: [
                              { required: true, message: '货物详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
