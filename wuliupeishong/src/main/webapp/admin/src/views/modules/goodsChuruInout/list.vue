<template>
    <div class="main-content">
        <el-dialog :title="goodsChuruInoutTitle" :visible.sync="goodsChuruInoutDialog">
            出入库订单名:<el-input prefix-icon="el-icon-search" v-model="goodsChuruInoutName" placeholder="出入库订单名" style="width: 200px" :readonly="isinfo?'readonly':false"></el-input>
            <span v-if="!isinfo" >
                货物信息信息:
                <el-select v-model="goodsId" filterable placeholder="请选择货物信息" >
                    <el-option
            ...
            <el-table :data="goodsChuruInoutData">
                ...
                <el-table-column property="goodsName" label="货物信息名字" width="200"></el-table-column>
                <el-table-column property="goodsMoney" label="货物信息价格" width="90"></el-table-column>
                <el-table-column property="goodsKucunNumber" label="货物信息库存" width="90"></el-table-column>
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '出入库名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.goodsChuruInoutName" placeholder="出入库名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/wuliupeishong/upload/goodsChuruInoutMuBan.xls"
                        >批量导入出入库数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('goodsChuruInout','导入导出')"
                                style="display: inline-block"
                                action="wuliupeishong/file/upload"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                //本表字段
                     '出入库流水号': "goodsChuruInoutUuidNumber",
                     '出入库名称': "goodsChuruInoutName",
                     '出入库类型': "goodsChuruInoutTypes",
                     '添加时间': "insertTime",
            },
            ...
            goodsOptions: [],
            goodsChuruInoutDialog :false,//出入库订单模态框
            ...
            addGoodsChuruInoutData(){
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        goods.goodsMoney = data.data.goodsMoney;
