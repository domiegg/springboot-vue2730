    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作证号" prop="yonghuUuidNumber">
                       <el-input v-model="ruleForm.yonghuUuidNumber"
                                 placeholder="工作证号" clearable  :readonly="ro.yonghuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工作证号" prop="yonghuUuidNumber">
                           <el-input v-model="ruleForm.yonghuUuidNumber"
                                     placeholder="工作证号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="居住地址" prop="yonghuAddress">
                       <el-input v-model="ruleForm.yonghuAddress"
                                 placeholder="居住地址" clearable  :readonly="ro.yonghuAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="居住地址" prop="yonghuAddress">
                           <el-input v-model="ruleForm.yonghuAddress"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="出生年月" prop="yonghuTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuTime" label="出生年月" prop="yonghuTime">
