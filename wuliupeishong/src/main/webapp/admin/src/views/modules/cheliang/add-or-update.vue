    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车辆数量" prop="cheliangNumber">
                       <el-input v-model="ruleForm.cheliangNumber"
                                 placeholder="车辆数量" clearable  :readonly="ro.cheliangNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="车辆数量" prop="cheliangNumber">
                           <el-input v-model="ruleForm.cheliangNumber"
