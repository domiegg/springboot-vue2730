    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司名称" prop="kehuGongshi">
                       <el-input v-model="ruleForm.kehuGongshi"
                                 placeholder="公司名称" clearable  :readonly="ro.kehuGongshi"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="公司名称" prop="kehuGongshi">
                           <el-input v-model="ruleForm.kehuGongshi"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司地址" prop="kehuAddress">
                       <el-input v-model="ruleForm.kehuAddress"
                                 placeholder="公司地址" clearable  :readonly="ro.kehuAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="公司地址" prop="kehuAddress">
                           <el-input v-model="ruleForm.kehuAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系人" prop="kehuName">
                       <el-input v-model="ruleForm.kehuName"
                                 placeholder="联系人" clearable  :readonly="ro.kehuName"></el-input>
                   </el-form-item>
                   <div v-else>
