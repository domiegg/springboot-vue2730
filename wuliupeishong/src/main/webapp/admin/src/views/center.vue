<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='工作证号' prop="yonghuUuidNumber">
               <el-input v-model="ruleForm.yonghuUuidNumber"  placeholder='工作证号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='居住地址' prop="yonghuAddress">
               <el-input v-model="ruleForm.yonghuAddress"  placeholder='居住地址' clearable></el-input>
           </el-form-item>
         </el-col>
